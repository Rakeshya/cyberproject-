...
async function detectSpam() {
    ...
    try {
        ...
        if (data.error) {
            emailResult.innerHTML = `<p style="color: var(--danger);">${data.error}</p>`;
            return;
        }
        ...
        if (data.result === "Spam") {
            emailResult.innerHTML = `
                <div style="text-align: center;">
                    <i class="fas fa-exclamation-triangle" style="color: var(--danger); font-size: 2rem; margin-bottom: 10px;"></i>
                    <h4 style="color: var(--danger); margin-bottom: 10px;">Spam Email Detected</h4>
                    <p>This email is likely spam or phishing.</p>
                    <div style="margin-top: 10px; font-size: 0.9rem; color: var(--text-secondary);">
        ...
        emailResult.innerHTML = `<p style="color: var(--danger);">Error analyzing email.</p>`;
    }
}
